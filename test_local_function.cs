...
public static class LuaScript
{
    ...
    {
((LuaFunction)env.GetVariable("print")).Call(new LuaValue[] { "Testing local function definitions" })        ;
...
((LuaFunction)env.GetVariable("print")).Call(new LuaValue[] { "addX(50) =", ((LuaFunction)env.GetVariable("addX")).Call(new LuaValue[] { 50 })[0] })        ;
...
return new LuaValue[] { ((LuaFunction)env.GetVariable("inner")).Call(new LuaValue[] { 10 })[0]             };
            return new LuaValue[0];
        }
        var outer_func = new LuaUserFunction(outer);
        env.SetVariable("outer", outer_func);
((LuaFunction)env.GetVariable("print")).Call(new LuaValue[] { "outer(5) =", ((LuaFunction)env.GetVariable("outer")).Call(new LuaValue[] { 5 })[0] })        ;
((LuaFunction)env.GetVariable("print")).Call(new LuaValue[] { "Local function test completed!" })        ;
        return new LuaValue[0];
    }
}
