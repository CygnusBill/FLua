...
public class CompilerIntegrationTests
{
    ...
    public void CompileAndExecute_VariableAssignment_WorksCorrectly()
    {
        ...
        Assert.IsTrue(yValue.IsInteger, "y should be LuaInteger");
        Assert.AreEqual(50L, yValue.AsInteger(), "y should equal 50");
    }
    ...
    public void CompileAndExecute_IfStatement_WorksCorrectly()
    {
        ...
        Assert.IsTrue(result.IsInteger, "result should be LuaInteger");
        Assert.AreEqual(1L, result.AsInteger(), "result should equal 1");
    }
    ...
    public void CompileAndExecute_WhileLoop_WorksCorrectly()
    {
        ...
        Assert.IsTrue(sum.IsInteger, "sum should be LuaInteger");
        Assert.AreEqual(10L, sum.AsInteger(), "sum should equal 10 (0+1+2+3+4)");
    }
    ...
    public void CompileAndExecute_RepeatUntilLoop_WorksCorrectly()
    {
        ...
        Assert.IsTrue(count.IsInteger, "count should be LuaInteger");
        Assert.AreEqual(3L, count.AsInteger(), "count should equal 3");
    }
    ...
    public void CompileAndExecute_NumericFor_WorksCorrectly()
    {
        ...
        var sum = env.GetVariable("sum");
        Assert.IsTrue(sum.IsInteger, "sum should be LuaInteger");
        Assert.AreEqual(15L, sum.AsInteger(), "sum should equal 15 (1+2+3+4+5)");
    }
    ...
    public void CompileAndExecute_NumericForWithStep_WorksCorrectly()
    {
        ...
        var count = env.GetVariable("count");
        Assert.IsTrue(count.IsInteger, "count should be LuaInteger");
        Assert.AreEqual(5L, count.AsInteger(), "count should equal 5 (10,8,6,4,2)");
    }
    ...
    public void CompileAndExecute_EmptyTableConstructor_WorksCorrectly()
    {
        ...
        Assert.IsTrue(t.IsTable, "t should be LuaTable");
        // Verify it's empty by checking a random key
        var value = t.AsTable<LuaTable>().Get(1);
        Assert.IsTrue(value.IsNil, "Empty table should return nil for any key");
    }
...
local sum = a + b + c
        ...
        var sum = env.GetVariable("sum");
        Assert.IsTrue(sum.IsInteger, "sum should be LuaInteger");
        Assert.AreEqual(60L, sum.AsInteger(), "sum should equal 60 (10+20+30)");
    }
...
local sum = a + b
        ...
        var sum = env.GetVariable("sum");
        Assert.IsTrue(sum.IsInteger, "sum should be LuaInteger");
        Assert.AreEqual(30L, sum.AsInteger(), "sum should equal 30 (10+20)");
    }
...
local sum = a + b + c
        ...
        var sum = env.GetVariable("sum");
        Assert.IsTrue(sum.IsInteger, "sum should be LuaInteger");
        Assert.AreEqual(420L, sum.AsInteger(), "sum should equal 420 (100+20+300)");
    }
...
local len = str:len()
        ...
        Assert.IsTrue(len.IsInteger, "len should be LuaInteger");
        Assert.AreEqual(5L, len.AsInteger(), "len should equal 5");
    }
...
local sum = a + b + c + d
        ...
        var sum = env.GetVariable("sum");
        Assert.IsTrue(sum.IsInteger, "sum should be LuaInteger");
        Assert.AreEqual(100L, sum.AsInteger(), "sum should equal 100 (10+20+30+40)");
    }
...
local p, q, r = dual()
        ...
        // Test 1: Equal variables and returns
        Assert.AreEqual(10L, env.GetVariable("a").AsInteger(), "a should be 10");
        Assert.AreEqual(20L, env.GetVariable("b").AsInteger(), "b should be 20");
        Assert.AreEqual(30L, env.GetVariable("c").AsInteger(), "c should be 30");
        
        // Test 2: Fewer variables than returns
        Assert.AreEqual(10L, env.GetVariable("x").AsInteger(), "x should be 10");
        Assert.AreEqual(20L, env.GetVariable("y").AsInteger(), "y should be 20");
        
        // Test 3: More variables than returns
        Assert.AreEqual(1L, env.GetVariable("p").AsInteger(), "p should be 1");
        Assert.AreEqual(2L, env.GetVariable("q").AsInteger(), "q should be 2");
        Assert.IsTrue(env.GetVariable("r").IsNil, "r should be nil");
    }
...
local d = nested.inner.data
        ...
        Assert.AreEqual(42L, env.GetVariable("v").AsInteger(), "v should be 42");
        Assert.AreEqual("test", env.GetVariable("n").AsString(), "n should be 'test'");
        Assert.AreEqual(6L, env.GetVariable("idx").AsInteger(), "idx should be 6 (position of space)");
        Assert.AreEqual(100L, env.GetVariable("d").AsInteger(), "d should be 100");
    }
}